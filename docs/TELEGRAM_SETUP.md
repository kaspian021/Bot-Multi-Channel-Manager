...
- `[🔎 Sources]`: Displays full titles and source links for provenance verification.

## 6. Testing via Embedded Simulator

If you do not have live Telegram credentials or wish to test locally:
1. Navigate to `/telegram-bot` in the web panel.
2. The interactive simulator executes all command routing and inline callback handlers.
3. Test identity switching between **Verified Owner** and **Impostor** to inspect access controls.
